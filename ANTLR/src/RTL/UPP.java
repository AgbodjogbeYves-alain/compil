...
class UPPNot extends UPPUnOp {
 ...
 RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                ArrayList<String> globals, PRegister reg, RTLInst succ) {
	 	PRegister reg1 = e.getPRegister(locals);
					return new RTLXOri(reg1, reg, succ);
...
class UPPAnd extends UPPBinOp {
 ...
 RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                ArrayList<String> globals, PRegister reg, RTLInst succ) {
	 PRegister reg1 = e1.getPRegister(locals);
	 PRegister reg2 = e2.getPRegister(locals);
...
class UPPLoad extends UPPExpr {
 ...
 RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                ArrayList<String> globals, PRegister reg, RTLInst succ) {
	 	PRegister reg1 = addr.getPRegister(locals);
...
class UPPProcCall extends UPPInst {
 ...
 RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                ArrayList<String> globals, RTLInst succ) {
	 ArrayList<PRegister> arraypr = new ArrayList<PRegister>();
	 
	for(Pair<String, PRegister> i : locals){
		arraypr.add(i.right);
	 }
	 
	 return new RTLProcCall(callee, arraypr, succ);
     //To do
 }//toRTL
